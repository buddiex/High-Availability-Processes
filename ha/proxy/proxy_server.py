...
class ProxyThreadAdmin(BaseMulitThreadAdmin):
    ...
    def __init__(self, parsed_args: argparse.ArgumentParser()):
        ...
        self.thread_Q_handlers.update({'REGISTER': self.handle_proxy_server_sap})
    ...
    def start_proxy_server_socket(self):
        ...
        server = ProxyServer(ProxyRequestHandler, server_conn, conf.PROXY_2_CLIENT_IP, conf.PROXY_2_CLIENT_PORT, self.thread_Q)
